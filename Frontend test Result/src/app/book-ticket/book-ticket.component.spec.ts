...
describe('BookTicketComponent', () => {
  ...
  let loginService: any;
    ...
    beforeEach(async () => {
      ...
      movieBookingServiceSpy = jasmine.createSpyObj(MovieBookingService, { 'getSubscription': of(), 'getAllMovies': of(movies), 'emailExists': of(true), 'changePassword': of(true), 'updateEmployee': of(true), 'addEmployee': of(true), 'deleteEmployee': of(true), 'download': of(true), 'changeActive': of(true), 'getCurrentUser': of(currentUser), 'uniqueEmailUsername': of(true), 'getMovieBasedOnId': of(movie), 'bookTicket':of(subscription) });
      routerSpy = jasmine.createSpyObj(Router, { 'navigate': of(true) });
  
      await TestBed.configureTestingModule({
        imports: [FormsModule, HttpClientTestingModule],
        declarations: [BookTicketComponent, CustomPipePipe],
        providers: [
    ...
    it('should book ticket', fakeAsync(() => {
      ...
      component.currentUser.role = "USER"
